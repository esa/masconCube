...
def main(gpus: list[int]):
    ...
    def gpu_worker(gpu_id: int):
        while not asteroid_queue.empty():
            ...
            train_script = Path(__file__).parent / "train_geodesynet.py"
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Train geodesynet on multiple GPUs")
    parser.description = (
        "This script trains geodesynet on multiple GPUs. "
