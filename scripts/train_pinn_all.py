...
def main(gpus: list[int]):
    ...
    def gpu_worker(gpu_id: int):
        while not asteroid_queue.empty():
            ...
            train_script = Path(__file__).parent / "train_pinn.py"
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Train PINN-GM on multiple GPUs")
    parser.description = (
        "This script trains the PINN-GM model on multiple GPUs"
